                                                ...
                                                <div class="nk-block-actions flex-shrink-sm-0">
                                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-3 gy-2">
                                                        <li class="order-md-last">
                                                            <a href="#" id="change-password-button" data-toggle="modal" data-target="#change-password" class="btn btn-primary">Change Password</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function() {
        $('#change-password-button').click(function() {
            ...
            // Additional logic or action here
        });
        $('#change-password-button').click(); // Trigger the click
    });
</script>
@endif
